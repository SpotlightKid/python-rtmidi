...
tweaked the code here and there. Kudos also to Florent AIDE for the exception handling mechanism.
...
Website : http://chrisarndt.de/en/software/python/threadpool.html
"""
...
class WorkRequest:
    ...
    def __init__(self, callable, args=None, kwds=None, requestID=None,
      callback=None, exc_callback=None):
        ...
        You also give a callback for when an exception occurs. It receives also
        two arguments, the work request and a tuple with exception info as
